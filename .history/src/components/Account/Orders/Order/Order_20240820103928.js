      ...
      >
        ...
        <div>
            <div className={styles.address}>
                ...
                <p className={styles.addressInfo}>{address.attributes.name}, {address.attributes.address}, {address.attributes.state}, {address.attributes.city}, {address.attributes.postal_code</p>
            </div>
        </div>
      </BasicModal>
    </>
